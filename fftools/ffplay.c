...
static int video_open(VideoState *is)
{
    ...
    buttons_init(&is->button_mgr, w, h);
...
static void video_display(VideoState *is)
{
    ...
    // Update and render button UI
    buttons_update_play_pause_label(&is->button_mgr, is->paused);
    buttons_render(&is->button_mgr, renderer);
    ...
    for (;;) {
        ...
        case SDL_MOUSEBUTTONDOWN:
            ...
            if (event.button.button == SDL_BUTTON_LEFT) {
                buttons_handle_mouse_button(&cur_stream->button_mgr,
        ...
        case SDL_MOUSEBUTTONUP:
            // Handle button click
            if (event.button.button == SDL_BUTTON_LEFT) {
                int button_id = buttons_handle_mouse_button(&cur_stream->button_mgr,
        ...
        case SDL_MOUSEMOTION:
            ...
            buttons_handle_mouse_motion(&cur_stream->button_mgr,
        ...
        case SDL_WINDOWEVENT:
            switch (event.window.event) {
                case SDL_WINDOWEVENT_SIZE_CHANGED:
                    ...
                    // Update button layout for new window size
                    buttons_update_layout(&cur_stream->button_mgr, screen_width, screen_height);
